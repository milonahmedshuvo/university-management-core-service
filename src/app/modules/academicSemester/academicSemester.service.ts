...
const getAllFromDB = async (filters: IAcademicSemesterFilterRequired, options: IPaginationOptions):Promise<IGenericResponse <AcademicSemester[]> > => {
    const { page, limit, skip } = paginationHelpers.calculatePagination(options)

    const {searchTerm, ...filtersData} = filters

   console.log({searchTerm, filtersData, options})
