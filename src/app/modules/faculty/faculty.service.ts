import { CourseFacalty, Faculty } from "@prisma/client";
...
const assignCourse = async (id: string, payload: string[] ):Promise<CourseFacalty[]> => {
...
const removeCourse =async (id:string, payload:string[]) => {
